...
const generateBranchPDFDocument = async (invoiceData: BranchInvoice) => {
      ...
      <Page size='A4' style={styles.page}>
        <View style={styles.header}>
          <View style={{ display: 'flex', flexDirection: 'row' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <Text>
                {invoiceData.grossMarket.address?.country +
                  ' ' +
                  invoiceData.grossMarket.address?.city +
                  ' ' +
                  invoiceData.grossMarket.address?.street}
              </Text>
        ...
        >
          ...
          >
            ...
            <Text>
              {invoiceData.billTo.address.country +
                ' ' +
                invoiceData.billTo.address.city +
                ' ' +
                invoiceData.billTo.address.street}
            </Text>
        ...
        <View style={{ border: 0.5 }}></View>
        {invoiceData.invoiceItems.map((order, key) => (
          <View
            style={{
              display: 'flex',
              flexDirection: 'row',
          ...
          >
            <View style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              <Text>Order {key + 1}</Text>
              <Text>
                Delivery date: {dayjs(order.deliveryDate).format('DD/MM/YYYY')}
              </Text>
            </View>
            <View style={{ display: 'flex', flexDirection: 'row' }}>
...
export default generateBranchPDFDocument;
